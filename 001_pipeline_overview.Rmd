...
__Results:__ See `MultiQC` report [here.](results/multiqc/raw/multiqc_report.html)
...
__Results:__ See `MultiQC` report [here.](results/multiqc/trimmed/multiqc_report.html)
...
This [counts matrix](results/star_raw/readcounts_raw.txt) can then be imported into `DESeq2.`
